...
这篇文章介绍了一种名为CHILD的紧凑型可重构遥操作系统，专为实现人形机器人的全身关节级控制而设计。以下是文章的主要内容总结：

背景与挑战：

随着机器人遥操作技术的进步，机器人能够执行复杂的操作任务，但现有系统较少支持人形机器人的全身关节级遥操作，限制了任务多样性。CHILD系统旨在解决这一问题，提供更灵活和多样化的控制方式。
CHILD系统的设计：

紧凑与便携：CHILD系统设计为可装在标准婴儿背带中，便于操作者穿戴，控制机器人四肢的全部运动。
控制方式：支持直接关节映射以实现全身控制，同时也支持行走与操作结合的“loco-manipulation”模式。
自适应力反馈：通过力反馈机制增强操作者体验，并防止不安全的关节运动，确保操作的稳定性和安全性。
